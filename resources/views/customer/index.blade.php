        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                    ...
                    <a href="{{ ('customer/add') }}" class="btn btn-sm btn-flat btn-primary "><i class="fa fa-plus"></i> Tambah Data</a>
                </p>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                <td>
                                    <div style="width:60px">
                                        ...
                                        <a href="{{ url('customer',$dt->id) }}" class="btn btn-danger btn-xs btn-hapus" id="delete"><i class="fa fa-trash-o"></i></a>
                                    </div>
                                </td>
                                <td>{{ $e+1 }}</td>
                                <td>{{ $dt->email }}</td>
